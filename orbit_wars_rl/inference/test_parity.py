...
def run_parity(
    ...
    for s in range(num_states):
        ...
        np_src, np_dst, np_pct, np_emit, np_value = nf.greedy_multi_action(
            ...
            planet_orbit_phase=np.asarray(state.planet_orbit_phase),
            planet_orbit_radius=np.asarray(state.planet_orbit_radius),
            planet_is_orbiting=np.asarray(state.planet_is_orbiting),
