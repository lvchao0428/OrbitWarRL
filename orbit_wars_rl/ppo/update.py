...
def ppo_loss(
    ...
    out = model.apply(
        ...
        rollout.planet_orbit_phase_raw,
        rollout.planet_orbit_radius_raw,
...
def _flatten_rollout(rollout: Rollout, advantages: jnp.ndarray, returns: jnp.ndarray):
    ...
    flat_rollout = Rollout(
        ...
        planet_orbit_phase_raw=f(rollout.planet_orbit_phase_raw),
        planet_orbit_radius_raw=f(rollout.planet_orbit_radius_raw),
        planet_is_orbiting_raw=f(rollout.planet_is_orbiting_raw),
        angular_velocity_raw=f(rollout.angular_velocity_raw),
...
def _gather_minibatch(rollout: Rollout, advs: jnp.ndarray, rets: jnp.ndarray, idx: jnp.ndarray):
    ...
    sub = Rollout(
        ...
        planet_orbit_phase_raw=take(rollout.planet_orbit_phase_raw),
        planet_orbit_radius_raw=take(rollout.planet_orbit_radius_raw),
        planet_is_orbiting_raw=take(rollout.planet_is_orbiting_raw),
        angular_velocity_raw=take(rollout.angular_velocity_raw),
