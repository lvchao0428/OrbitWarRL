"""Orbit Wars RL v11 f38 — curriculum training (same arch as f37).

Feature dims: PLANET=33, GLOBAL=18, EMIT_PAIR=6, K=8.
Hard masks: EMIT_HARD_STOP=1, F31_HARD_MASKS=1.

Weights injected by ``orbit_wars_rl/scripts/export_submission.py``.
"""
