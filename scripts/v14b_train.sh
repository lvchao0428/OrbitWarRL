#!/usr/bin/env bash
# v14b — 从头训练（5090 / 本地 GPU）
#
# Usage:
#   bash scripts/v14b_train.sh
#   nohup bash scripts/v14b_train.sh > logs/v14b.log 2>&1 &
...
mkdir -p logs ckpt_multi_action_v14b
...
echo "[v14b] starting from scratch — allow_hold=false min_pct_bin=5 capture=0.08"
