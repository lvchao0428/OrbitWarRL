#!/usr/bin/env bash
# v11_f29: full signal stack, no buffer, from scratch.
set -euo pipefail
...
CFG="orbit_wars_rl/configs/multi_action_v11_f29.yaml"
LOG="logs/v11_f29.log"
TB="logs/v11_f29"
...
echo "[v11_f29] py=$PY cfg=$CFG log=$LOG (foreground — use overnight script for serial)"
