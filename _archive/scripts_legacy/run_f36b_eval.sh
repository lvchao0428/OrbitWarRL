#!/usr/bin/env bash
# Post-train f36b eval: replay dense early checkpoints vs v20.
#
...
CKPT_DIR="${CKPT_DIR:-ckpt_multi_action_v11_f36b}"
F29_CKPT="${F29_CKPT:-ckpt_multi_action_v11_f29/ckpt_000599.pkl}"

echo "=== f36b eval: $CKPT_DIR vs v20 ==="
echo "=== training log health ==="
bash scripts/check_training_health.sh logs/v11_f36b.log || true
...
echo ""
echo "=== gate summaries ==="
for TAG in v11_f36b_u149 v11_f36b_u199 v11_f36b_u249 v11_f36b_u299 v11_f36b_u349 v11_f29_u599_baseline; do
