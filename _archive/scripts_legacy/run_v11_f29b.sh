#!/usr/bin/env bash
# v11_f29b: f29 signals + buffer 0.8 + emit_hard_stop, from scratch.
set -euo pipefail
...
CFG="orbit_wars_rl/configs/multi_action_v11_f29b.yaml"
LOG="logs/v11_f29b.log"
TB="logs/v11_f29b"
...
echo "[v11_f29b] py=$PY cfg=$CFG log=$LOG emit_hard_stop=true"
