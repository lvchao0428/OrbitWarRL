#!/usr/bin/env bash
# Post-train f33 eval: replay key checkpoints vs v20.
#
# Priority: @399 (pre self-play spf inflation @449), then @599/@1199/@1999.
#
# Usage (5090 after ckpts synced):
#   bash scripts/run_f33_eval.sh
#   CKPT_DIR=ckpt_multi_action_v11_f33 bash scripts/run_f33_eval.sh
...
CKPT_DIR="${CKPT_DIR:-ckpt_multi_action_v11_f33}"
F29_CKPT="${F29_CKPT:-ckpt_multi_action_v11_f29/ckpt_000599.pkl}"

echo "=== f33 eval: $CKPT_DIR vs v20 ==="
echo "=== training log health ==="
bash scripts/check_training_health.sh logs/v11_f33.log || true

for U in 399 599 1199 1999; do
...
echo ""
echo "=== gate summaries (first line each) ==="
for TAG in v11_f33_u399 v11_f33_u599 v11_f33_u1199 v11_f33_u1999 v11_f29_u599_baseline; do
