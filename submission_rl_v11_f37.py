"""Orbit Wars RL v11 f37 — strengthen fundamental action signals.

Deltas vs f35:
  - GLOBAL_FEAT_DIM 17 -> 18  (+min_effective_fleet_norm at dim 17)
  - emit_pair_globals 4 -> 6  (+feasible_target_count_norm, +surplus_ratio)
  - All reward shaping set to 0; pure +1/-1 terminal reward.

Feature dims:
  - PLANET_FEAT_DIM = 33  (same 33 dims as f35)
  - FLEET_FEAT_DIM  = 10
  - GLOBAL_FEAT_DIM = 18  (f35 17 + min_effective_fleet_norm)
